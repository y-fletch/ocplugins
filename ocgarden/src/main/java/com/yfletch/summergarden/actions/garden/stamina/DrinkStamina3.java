...
public class DrinkStamina3 extends ItemAction
{
	public DrinkStamina3()
	{
		super("Stamina potion (3)", Consts.DRINK);
	}
	...
	{
		event.itemAction(2, MenuAction.CC_OP, Consts.STAMINA_3);
	}
